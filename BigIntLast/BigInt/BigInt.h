...
public:
	...
	static void Mod(BigInt &bt,BigInt &bt1,BigInt &bt2);	//取模
public:
	...
	static void Power(BigInt &bt,BigInt &bt1,BigInt &bt2);
	static void Power(BigInt &bt,BigInt &bt1,long n);
public:
	//重载函数
