...
int configparser::initkvmap(string conf)
{
            ...
            it != lines.end(); ++it)
    {
        ...
        //glogger << "matched" << endl;
        //glogger << pmatch[1].rm_so << ": 1 start"<< endl;
        //glogger << pmatch[1].rm_eo << ": 1 end"<< endl;
        //
        ...
        kvmap[key] = value;
        //glogger << "key: " << key << endl;
        //glogger << "value: " << value << endl;
    }
